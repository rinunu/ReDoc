...
var SchemaWalker = /** @class */ (function () {
    ...
    SchemaWalker.walk = function (obj, pointer, visitor) {
        ...
        if (obj['x-redoc-visited']) {
            var res_1 = visitor(obj, pointer);
            obj['x-redoc-visited'] = false;
            // circular, return only title and description
            return { title: res_1.title, description: res_1.description };
        }
        ...
        if (obj.additionalProperties) {
            ...
            if (Array.isArray(obj.additionalProperties)) {
                ...
                var res_2 = SchemaWalker.walk(obj.additionalProperties, ptr, visitor);
                if (res_2)
                    obj.additionalProperties = res_2;
            }
        }
        if (obj.allOf) {
        ...
        if (obj.items) {
            ...
            if (Array.isArray(obj.items)) {
                ...
                var res_3 = SchemaWalker.walk(obj.items, ptr, visitor);
                if (res_3)
                    obj.items = res_3;
            }
        }
        var res = visitor(obj, pointer);
        obj['x-redoc-visited'] = false;
        return res;
    };
